...
-spec del_subscription(Subscriber::pid(), Target::comm:mypid(), Cookie::fd:cookie()) -> true.
...
-spec get_subscribers(Target::comm:mypid(), Cookie::fd:cookie()) -> [{pid(), fd:cookie()}].
...
-spec add_pinger(Target::comm:mypid(), Pinger::pid()) -> true.
add_pinger(Target, Pinger) ->
    ets:insert(fd_pinger_table, {Target, Pinger}).

-spec get_pinger(Target::comm:mypid()) -> none | {ok,pid()}.
get_pinger(Target) ->
...
-spec del_pinger(Target::comm:mypid()) -> true.
del_pinger(Target) ->
