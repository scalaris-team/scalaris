        ...
        case Request of
            ...
            {set_change, Key, ToAdd, ToRemove} ->
                ...
                case Result1 of
                    ...
                    {fail, not_found} ->
                        ...
                        single_req(TLog1, {rdht_tx_write, Key, encode_value(NewValue2)});
                    {ok, _} ->
                        % need to manipulate tlog to contain this error
                        TLog2 = tx_tlog:update_status_by_key(TLog1, Key, {fail, not_a_list}),
                        {TLog2, {fail, not_a_list}};
            ...
            {number_add, Key, X} ->
                ...
                case Result1 of
                    ...
                    {ok, _} ->
                        % need to manipulate tlog to contain this error
                        TLog2 = tx_tlog:update_status_by_key(TLog1, Key, {fail, not_a_number}),
                        {TLog2, {fail, not_a_number}};
            ...
            {test_and_set, Key, Old, New} ->
                ...
                case Result1 of
                    ...
                    {ok, RealOldValue} ->
                        % need to manipulate tlog to contain this error
                        TLog2 = tx_tlog:update_status_by_key(TLog1, Key, {fail, {key_changed, RealOldValue}}),
                        {TLog2, {fail, {key_changed, RealOldValue}}};
                    X when erlang:is_tuple(X) ->
                        {TLog1, X}
                end
        end,
