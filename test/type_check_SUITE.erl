        ...
        [ {rr_recon_stats, [], []},
          ...
          {rr_recon,
           ...
           [
             ...
             {merkle_resolve_compare_inner_leaf, 8}, %% needs special bitstring
             ...
             {merkle_resolve_leaves_init, 12}, % needs only leaf nodes in node list
             {merkle_resolve_req_keys_noninit, 12}, % needs only leaf nodes in node list, same-length lists
