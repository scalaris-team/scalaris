...
test_filter3(_Config) ->
    ...
    ?equals(_N14 = ets:tab2list(RemovedNodesTab), [{N50}]),
    ets:delete_all_objects(RemovedNodesTab),
    ?compare_neighborhood(nodelist:filter(Neighb1, fun(N) -> not lists:member(node:id(N), [8, 14]) end, AddNodeToTabFun),
                          N33, 33, N50, [N50, N42], N42, [N42, N50], true, true),
...
largest_smaller_than2(_Config) ->
    ...
    prop_largest_smaller_than2(
      {node, {{{197,151,185,165},1,{one,'ct@csr-pc40'}}, c,{}}, 1,0, 8000},
      [{node, {{{197,151,185,165},1,{one,'ct@csr-pc40'}}, c,{}}, 3,5, 8000},
       {node, {{{39,220,200,75},3,{two,'ct@csr-pc40'}}, c,101.41898888632392},4,0, 8000},
       {node, {{10,87,88,118},1,{three,'ct@csr-pc40'}}, 5,4, 8000}],
      1, 1, 5),
    ...
    prop_largest_smaller_than2(
      ...
      [{node,
       ...
       {node,
        ...
        5,0, 8000},
       {node, {{{25,8,53,113}, 5, {four,'ct@csr-pc40'}}, c, {3}}, 2,4, 8000}],
      1, 1, 5).
...
largest_smaller_than3(_Config) ->
    ...
    prop_largest_smaller_than3_fixed_types(
      {node, proc1, 5, 5, 8000},
      [{node, proc2, 0, 2, 8000}, {node, proc3, 3, 2, 8000}],
      1, 3, 5, {node, proc2, 0, 2, 8000}),
    
    prop_largest_smaller_than3_fixed_types(
        {node, proc1, 2, 1, 8000},
        [{node, proc2, 5, 0, 8000}, {node, proc3, 4, 4, 8000}],
        2, 5, 3, {node, proc4, 5, 0, 8000}),
