...
public class StoreUtils {
	...
	/*
	 * Utility to store multiple objects.
	 * The order in which objects are stored is not guaranteed.
	 */
	 ...
	 */
	public static Object retrieveObjectBySingleKey(Class<?> objectClass, Object keyValue) {
		PersistenceManager pm = getNewPersistenceManager();
		Transaction tx = pm.currentTransaction();
