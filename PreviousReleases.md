...
#### Business Logic ####
  ...
  * add new routing algorithms FRT-Chord (flexible routing tables) and GFRT-Chord (supports proximity routing and data centers) as alternatives to Chord (see rt\_frtchord and rt\_gfrtchord modules)
