...
\newcommand{\code}[1]{\lstinline[basicstyle=\smaller\ttfamily]!#1!}
...
contacted. Their responses are then handled in phase~2.
...
candidates by using the passive load balance algorithm and send a 
\code{join_request} message continuing in phase~4. 
