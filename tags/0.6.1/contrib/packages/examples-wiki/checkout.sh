...
SCALARIS_VERSION="0.6.1"
date=`date +"%Y%m%d"`
name="scalaris-examples-wiki" # folder base name (without version)
url="http://scalaris.googlecode.com/svn/branches/0.6/contrib/wikipedia"
package_url="http://scalaris.googlecode.com/svn/branches/0.6/contrib/packages/examples-wiki"
