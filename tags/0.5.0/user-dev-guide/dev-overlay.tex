...
\erlfunindex{rt\_beh}{wrap_message}
\item \code{wrap_message/1} wraps a message send via a \code{dht_node_lookup:lookup_aux/4}.

\erlfunindex{rt\_beh}{unwrap_message}
\item \code{wrap_message/2} unwraps a message send via \code{dht_node_lookup:lookup_aux/4}
...
\erlfunindex{rt\_simple}{wrap_message}
...
\erlfunindex{rt\_simple}{unwrap_message}
