...
% TODO: interval_upd currently only used by ART
% (a future version will probably drop that)
% however, the interval_upd may be useful anyway

% \subsection{Updating an interval - \code{interval_upd}}