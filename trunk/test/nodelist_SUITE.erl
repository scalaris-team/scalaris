...
test_filter2(_Config) ->
    ...
    % Neighb1 = nodelist:mk_neighborhood([N8, N14, N42, N50], N33),
    % remove existing nodes:
    ?compare_neighborhood(nodelist:filter(Neighb1, fun(N) -> not node:equals(N, N8) end),
                          N33, 33, N14, [N14, N50, N42], N42, [N42, N50, N14], true, true),
    ?compare_neighborhood(nodelist:filter(Neighb1, fun(N) -> not node:equals(N, N14) end),
                          N33, 33, N8, [N8, N50, N42], N42, [N42, N50, N8], true, true),
    ?compare_neighborhood(nodelist:filter(Neighb1, fun(N) -> not node:equals(N, N42) end),
                          N33, 33, N14, [N14, N8, N50], N50, [N50, N8, N14], true, true),
    ?compare_neighborhood(nodelist:filter(Neighb1, fun(N) -> not node:equals(N, N50) end),
                          N33, 33, N14, [N14, N8, N42], N42, [N42, N8, N14], true, true),

    % remove non-existing nodes and pids:
    ?equals(nodelist:filter(Neighb1, fun(N) -> not node:equals(N, N20) end), Neighb1),
    ?equals(nodelist:filter(Neighb1, fun(N) -> not node:equals(N, N66) end), Neighb1),

    % Neighb2 = nodelist:mk_neighborhood([N8, N14, N42, N50], N33, 3, 3),
    % remove existing nodes:
    ?compare_neighborhood(nodelist:filter(Neighb2, fun(N) -> not node:equals(N, N8) end),
                          N33, 33, N14, [N14, N50], N42, [N42, N50], true, true),
    ?compare_neighborhood(nodelist:filter(Neighb2, fun(N) -> not node:equals(N, N14) end),
                          N33, 33, N8, [N8, N50], N42, [N42, N50, N8], true, true),
    ?compare_neighborhood(nodelist:filter(Neighb2, fun(N) -> not node:equals(N, N42) end),
                          N33, 33, N14, [N14, N8, N50], N50, [N50, N8], true, true),
    ?compare_neighborhood(nodelist:filter(Neighb2, fun(N) -> not node:equals(N, N50) end),
                          N33, 33, N14, [N14, N8], N42, [N42, N8], true, true),

    % remove non-existing nodes and pids:
    ?equals(nodelist:filter(Neighb2, fun(N) -> not node:equals(N, N20) end), Neighb2),
    ?equals(nodelist:filter(Neighb2, fun(N) -> not node:equals(N, N66) end), Neighb2),

    % Neighb3 = nodelist:mk_neighborhood([N8, N14, N42, N50], N33, 2, 2),
    % remove existing nodes:
    ?compare_neighborhood(nodelist:filter(Neighb3, fun(N) -> not node:equals(N, N8) end),
                          N33, 33, N14, [N14], N42, [N42, N50], true, true),
    ?compare_neighborhood(nodelist:filter(Neighb3, fun(N) -> not node:equals(N, N14) end),
                          N33, 33, N8, [N8], N42, [N42, N50], true, true),
    ?compare_neighborhood(nodelist:filter(Neighb3, fun(N) -> not node:equals(N, N42) end),
                          N33, 33, N14, [N14, N8], N50, [N50], true, true),
    ?compare_neighborhood(nodelist:filter(Neighb3, fun(N) -> not node:equals(N, N50) end),
                          N33, 33, N14, [N14, N8], N42, [N42], true, true),

    % remove non-existing nodes and pids:
    ?equals(nodelist:filter(Neighb3, fun(N) -> not node:equals(N, N20) end), Neighb3),
    ?equals(nodelist:filter(Neighb3, fun(N) -> not node:equals(N, N66) end), Neighb3),

    % Neighb4 = nodelist:mk_neighborhood([N8, N14, N42, N50], N33, 1, 1),
    % remove existing nodes:
    ?compare_neighborhood(nodelist:filter(Neighb4, fun(N) -> not node:equals(N, N8) end),
                          N33, 33, N14, [N14], N42, [N42], true, true),
    ?compare_neighborhood(nodelist:filter(Neighb4, fun(N) -> not node:equals(N, N14) end),
                          N33, 33, N42, [N42], N42, [N42], true, true),
    ?compare_neighborhood(nodelist:filter(Neighb4, fun(N) -> not node:equals(N, N42) end),
                          N33, 33, N14, [N14], N14, [N14], true, true),
    ?compare_neighborhood(nodelist:filter(Neighb4, fun(N) -> not node:equals(N, N50) end),
                          N33, 33, N14, [N14], N42, [N42], true, true),

    % remove non-existing nodes and pids:
    ?equals(nodelist:filter(Neighb4, fun(N) -> not node:equals(N, N20) end), Neighb4),
    ?equals(nodelist:filter(Neighb4, fun(N) -> not node:equals(N, N66) end), Neighb4),

    % Neighb5 = nodelist:mk_neighborhood([N14], N33, 1, 1),
    % remove existing nodes:
    ?compare_neighborhood(nodelist:filter(Neighb5, fun(N) -> not node:equals(N, N14) end),
                          N33, 33, N33, [N33], N33, [N33], false, false),

    % remove non-existing nodes and pids:
    ?equals(nodelist:filter(Neighb5, fun(N) -> not node:equals(N, N20) end), Neighb5),
    ?equals(nodelist:filter(Neighb5, fun(N) -> not node:equals(N, N9) end), Neighb5),

    % Neighb6 = nodelist:mk_neighborhood([], N33, 1, 1),
    % remove non-existing nodes and pids:
    ?equals(nodelist:filter(Neighb6, fun(N) -> not node:equals(N, N20) end), Neighb6),
    ?equals(nodelist:filter(Neighb6, fun(N) -> not node:equals(N, N9) end), Neighb6),
...
test_filter3(_Config) ->
    ...
    % Neighb1 = nodelist:mk_neighborhood([N8, N14, N42, N50], N33),
    % remove existing nodes:
    ?compare_neighborhood(nodelist:filter(Neighb1, fun(N) -> not node:equals(N, N8) end, AddNodeToTabFun),
                          N33, 33, N14, [N14, N50, N42], N42, [N42, N50, N14], true, true),
    ?equals(_N11 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([N8, N8])),
    ets:delete_all_objects(RemovedNodesTab),
    ?compare_neighborhood(nodelist:filter(Neighb1, fun(N) -> not node:equals(N, N14) end, AddNodeToTabFun),
                          N33, 33, N8, [N8, N50, N42], N42, [N42, N50, N8], true, true),
    ?equals(_N12 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([N14, N14])),
    ets:delete_all_objects(RemovedNodesTab),
    ?compare_neighborhood(nodelist:filter(Neighb1, fun(N) -> not node:equals(N, N42) end, AddNodeToTabFun),
                          N33, 33, N14, [N14, N8, N50], N50, [N50, N8, N14], true, true),
    ?equals(_N13 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([N42, N42])),
    ets:delete_all_objects(RemovedNodesTab),
    ?compare_neighborhood(nodelist:filter(Neighb1, fun(N) -> not node:equals(N, N50) end, AddNodeToTabFun),
                          N33, 33, N14, [N14, N8, N42], N42, [N42, N8, N14], true, true),
    ?equals(_N14 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([N50, N50])),
    ets:delete_all_objects(RemovedNodesTab),

    % remove non-existing nodes and pids:
    ?equals(nodelist:filter(Neighb1, fun(N) -> not node:equals(N, N20) end, AddNodeToTabFun), Neighb1),
    ?equals(_N110 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([])),
    ets:delete_all_objects(RemovedNodesTab),
    ?equals(nodelist:filter(Neighb1, fun(N) -> not node:equals(N, N66) end, AddNodeToTabFun), Neighb1),
    ?equals(_N111 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([])),
    ets:delete_all_objects(RemovedNodesTab),

    % Neighb2 = nodelist:mk_neighborhood([N8, N14, N42, N50], N33, 3, 3),
    % remove existing nodes:
    ?compare_neighborhood(nodelist:filter(Neighb2, fun(N) -> not node:equals(N, N8) end, AddNodeToTabFun),
                          N33, 33, N14, [N14, N50], N42, [N42, N50], true, true),
    ?equals(_N21 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([N8, N8])),
    ets:delete_all_objects(RemovedNodesTab),
    ?compare_neighborhood(nodelist:filter(Neighb2, fun(N) -> not node:equals(N, N14) end, AddNodeToTabFun),
                          N33, 33, N8, [N8, N50], N42, [N42, N50, N8], true, true),
    ?equals(_N22 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([N14])),
    ets:delete_all_objects(RemovedNodesTab),
    ?compare_neighborhood(nodelist:filter(Neighb2, fun(N) -> not node:equals(N, N42) end, AddNodeToTabFun),
                          N33, 33, N14, [N14, N8, N50], N50, [N50, N8], true, true),
    ?equals(_N23 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([N42])),
    ets:delete_all_objects(RemovedNodesTab),
    ?compare_neighborhood(nodelist:filter(Neighb2, fun(N) -> not node:equals(N, N50) end, AddNodeToTabFun),
                          N33, 33, N14, [N14, N8], N42, [N42, N8], true, true),
    ?equals(_N24 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([N50, N50])),
    ets:delete_all_objects(RemovedNodesTab),

    % remove non-existing nodes and pids:
    ?equals(nodelist:filter(Neighb2, fun(N) -> not node:equals(N, N20) end, AddNodeToTabFun), Neighb2),
    ?equals(_N210 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([])),
    ets:delete_all_objects(RemovedNodesTab),
    ?equals(nodelist:filter(Neighb2, fun(N) -> not node:equals(N, N66) end, AddNodeToTabFun), Neighb2),
    ?equals(_N211 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([])),
    ets:delete_all_objects(RemovedNodesTab),

    % Neighb3 = nodelist:mk_neighborhood([N8, N14, N42, N50], N33, 2, 2),
    % remove existing nodes:
    ?compare_neighborhood(nodelist:filter(Neighb3, fun(N) -> not node:equals(N, N8) end, AddNodeToTabFun),
                          N33, 33, N14, [N14], N42, [N42, N50], true, true),
    ?equals(_N31 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([N8])),
    ets:delete_all_objects(RemovedNodesTab),
    ?compare_neighborhood(nodelist:filter(Neighb3, fun(N) -> not node:equals(N, N14) end, AddNodeToTabFun),
                          N33, 33, N8, [N8], N42, [N42, N50], true, true),
    ?equals(_N32 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([N14])),
    ets:delete_all_objects(RemovedNodesTab),
    ?compare_neighborhood(nodelist:filter(Neighb3, fun(N) -> not node:equals(N, N42) end, AddNodeToTabFun),
                          N33, 33, N14, [N14, N8], N50, [N50], true, true),
    ?equals(_N33 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([N42])),
    ets:delete_all_objects(RemovedNodesTab),
    ?compare_neighborhood(nodelist:filter(Neighb3, fun(N) -> not node:equals(N, N50) end, AddNodeToTabFun),
                          N33, 33, N14, [N14, N8], N42, [N42], true, true),
    ?equals(_N34 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([N50])),
    ets:delete_all_objects(RemovedNodesTab),

    % remove non-existing nodes and pids:
    ?equals(nodelist:filter(Neighb3, fun(N) -> not node:equals(N, N20) end, AddNodeToTabFun), Neighb3),
    ?equals(_N310 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([])),
    ets:delete_all_objects(RemovedNodesTab),
    ?equals(nodelist:filter(Neighb3, fun(N) -> not node:equals(N, N66) end, AddNodeToTabFun), Neighb3),
    ?equals(_N311 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([])),
    ets:delete_all_objects(RemovedNodesTab),

    % Neighb4 = nodelist:mk_neighborhood([N8, N14, N42, N50], N33, 1, 1),
    % remove existing nodes:
    ?compare_neighborhood(nodelist:filter(Neighb4, fun(N) -> not node:equals(N, N8) end, AddNodeToTabFun),
                          N33, 33, N14, [N14], N42, [N42], true, true),
    ?equals(_N41 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([])),
    ets:delete_all_objects(RemovedNodesTab),
    ?compare_neighborhood(nodelist:filter(Neighb4, fun(N) -> not node:equals(N, N14) end, AddNodeToTabFun),
                          N33, 33, N42, [N42], N42, [N42], true, true),
    ?equals(_N42 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([N14])),
    ets:delete_all_objects(RemovedNodesTab),
    ?compare_neighborhood(nodelist:filter(Neighb4, fun(N) -> not node:equals(N, N42) end, AddNodeToTabFun),
                          N33, 33, N14, [N14], N14, [N14], true, true),
    ?equals(_N43 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([N42])),
    ets:delete_all_objects(RemovedNodesTab),
    ?compare_neighborhood(nodelist:filter(Neighb4, fun(N) -> not node:equals(N, N50) end, AddNodeToTabFun),
                          N33, 33, N14, [N14], N42, [N42], true, true),
    ?equals(_N44 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([])),
    ets:delete_all_objects(RemovedNodesTab),

    % remove non-existing nodes and pids:
    ?equals(nodelist:filter(Neighb4, fun(N) -> not node:equals(N, N20) end, AddNodeToTabFun), Neighb4),
    ?equals(_N410 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([])),
    ets:delete_all_objects(RemovedNodesTab),
    ?equals(nodelist:filter(Neighb4, fun(N) -> not node:equals(N, N66) end, AddNodeToTabFun), Neighb4),
    ?equals(_N411 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([])),
    ets:delete_all_objects(RemovedNodesTab),

    % Neighb5 = nodelist:mk_neighborhood([N14], N33, 1, 1),
    % remove existing nodes:
    ?compare_neighborhood(nodelist:filter(Neighb5, fun(N) -> not node:equals(N, N14) end, AddNodeToTabFun),
                          N33, 33, N33, [N33], N33, [N33], false, false),
    ?equals(_N51 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([N14, N14])),
    ets:delete_all_objects(RemovedNodesTab),

    % remove non-existing nodes and pids:
    ?equals(nodelist:filter(Neighb5, fun(N) -> not node:equals(N, N20) end, AddNodeToTabFun), Neighb5),
    ?equals(_N510 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([])),
    ets:delete_all_objects(RemovedNodesTab),
    ?equals(nodelist:filter(Neighb5, fun(N) -> not node:equals(N, N9) end, AddNodeToTabFun), Neighb5),
    ?equals(_N511 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([])),
    ets:delete_all_objects(RemovedNodesTab),

    % Neighb6 = nodelist:mk_neighborhood([], N33, 1, 1),
    % remove non-existing nodes and pids:
    ?equals(nodelist:filter(Neighb6, fun(N) -> not node:equals(N, N20) end, AddNodeToTabFun), Neighb6),
    ?equals(_N610 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([])),
    ets:delete_all_objects(RemovedNodesTab),
    ?equals(nodelist:filter(Neighb6, fun(N) -> not node:equals(N, N9) end, AddNodeToTabFun), Neighb6),
    ?equals(_N611 = lists:sort(ets:tab2list(RemovedNodesTab)), NodeListToTabListFun([])),
    ets:delete_all_objects(RemovedNodesTab),
...
test_filter_min_length4(_Config) ->
    ...
    % Neighb1 = nodelist:mk_neighborhood([N8, N14, N42, N50], N33),
    % remove existing nodes:
    ?compare_neighborhood(nodelist:filter_min_length(Neighb1, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 0, 0),
                          N33, 33, N14, [N14, N42], N42, [N42, N14], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb1, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 1, 1),
                          N33, 33, N14, [N14, N42], N42, [N42, N14], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb1, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 2, 2),
                          N33, 33, N14, [N14, N42], N42, [N42, N14], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb1, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 3, 3),
                          N33, 33, N14, [N14, N8, N42], N42, [N42, N50, N14], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb1, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 4, 4),
                          N33, 33, N14, [N14, N8, N50, N42], N42, [N42, N50, N8, N14], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb1, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 5, 5),
                          N33, 33, N14, [N14, N8, N50, N42], N42, [N42, N50, N8, N14], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb1, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 2, 4),
                          N33, 33, N14, [N14, N42], N42, [N42, N50, N8, N14], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb1, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 4, 2),
                          N33, 33, N14, [N14, N8, N50, N42], N42, [N42, N14], true, true),

    % remove non-existing nodes and pids:
    ?equals(nodelist:filter_min_length(Neighb1, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 0, 0), Neighb1),
    ?equals(nodelist:filter_min_length(Neighb1, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 3, 3), Neighb1),
    ?equals(nodelist:filter_min_length(Neighb1, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 2, 5), Neighb1),
    ?equals(nodelist:filter_min_length(Neighb1, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 5, 2), Neighb1),

    % Neighb2 = nodelist:mk_neighborhood([N8, N14, N42, N50], N33, 3, 3),
    % remove existing nodes:
    ?compare_neighborhood(nodelist:filter_min_length(Neighb2, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 0, 0),
                          N33, 33, N14, [N14], N42, [N42], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb2, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 1, 1),
                          N33, 33, N14, [N14], N42, [N42], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb2, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 2, 2),
                          N33, 33, N14, [N14, N8], N42, [N42, N50], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb2, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 3, 3),
                          N33, 33, N14, [N14, N8, N50], N42, [N42, N50, N8], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb2, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 4, 4),
                          N33, 33, N14, [N14, N8, N50], N42, [N42, N50, N8], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb2, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 2, 4),
                          N33, 33, N14, [N14, N8], N42, [N42, N50, N8], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb2, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 4, 2),
                          N33, 33, N14, [N14, N8, N50], N42, [N42, N50], true, true),

    % remove non-existing nodes and pids:
    ?equals(nodelist:filter_min_length(Neighb2, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 0, 0), Neighb2),
    ?equals(nodelist:filter_min_length(Neighb2, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 3, 3), Neighb2),
    ?equals(nodelist:filter_min_length(Neighb2, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 2, 5), Neighb2),
    ?equals(nodelist:filter_min_length(Neighb2, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 5, 2), Neighb2),

    % Neighb3 = nodelist:mk_neighborhood([N8, N14, N42, N50], N33, 2, 2),
    % remove existing nodes:
    ?compare_neighborhood(nodelist:filter_min_length(Neighb3, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 0, 0),
                          N33, 33, N14, [N14], N42, [N42], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb3, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 1, 1),
                          N33, 33, N14, [N14], N42, [N42], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb3, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 2, 2),
                          N33, 33, N14, [N14, N8], N42, [N42, N50], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb3, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 3, 3),
                          N33, 33, N14, [N14, N8], N42, [N42, N50], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb3, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 2, 4),
                          N33, 33, N14, [N14, N8], N42, [N42, N50], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb3, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N50)) end, 4, 2),
                          N33, 33, N14, [N14, N8], N42, [N42, N50], true, true),

    % remove non-existing nodes and pids:
    ?equals(nodelist:filter_min_length(Neighb3, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 0, 0), Neighb3),
    ?equals(nodelist:filter_min_length(Neighb3, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 3, 3), Neighb3),
    ?equals(nodelist:filter_min_length(Neighb3, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 2, 5), Neighb3),
    ?equals(nodelist:filter_min_length(Neighb3, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 5, 2), Neighb3),

    % Neighb4 = nodelist:mk_neighborhood([N8, N14, N42, N50], N33, 1, 1),
    % remove existing nodes:
    ?compare_neighborhood(nodelist:filter_min_length(Neighb4, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N42)) end, 0, 0),
                          N33, 33, N14, [N14], N14, [N14], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb4, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N42)) end, 1, 1),
                          N33, 33, N14, [N14], N42, [N42], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb4, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N42)) end, 2, 2),
                          N33, 33, N14, [N14], N42, [N42], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb4, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N42)) end, 0, 1),
                          N33, 33, N14, [N14], N42, [N42], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb4, fun(N) -> not (node:equals(N, N8) orelse node:equals(N, N42)) end, 1, 0),
                          N33, 33, N14, [N14], N14, [N14], true, true),

    % remove non-existing nodes and pids:
    ?equals(nodelist:filter_min_length(Neighb4, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 0, 0), Neighb4),
    ?equals(nodelist:filter_min_length(Neighb4, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 3, 3), Neighb4),
    ?equals(nodelist:filter_min_length(Neighb4, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 2, 5), Neighb4),
    ?equals(nodelist:filter_min_length(Neighb4, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 5, 2), Neighb4),

    % Neighb5 = nodelist:mk_neighborhood([N14], N33, 1, 1),
    % remove existing nodes:
    ?compare_neighborhood(nodelist:filter_min_length(Neighb5, fun(N) -> not node:equals(N, N14) end, 0, 0),
                          N33, 33, N33, [N33], N33, [N33], false, false),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb5, fun(N) -> not node:equals(N, N14) end, 1, 1),
                          N33, 33, N14, [N14], N14, [N14], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb5, fun(N) -> not node:equals(N, N14) end, 0, 1),
                          N33, 33, N14, [N14], N14, [N14], true, true),
    ?compare_neighborhood(nodelist:filter_min_length(Neighb5, fun(N) -> not node:equals(N, N14) end, 1, 0),
                          N33, 33, N14, [N14], N14, [N14], true, true),

    % remove non-existing nodes and pids:
    ?equals(nodelist:filter_min_length(Neighb5, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 0, 0), Neighb5),
    ?equals(nodelist:filter_min_length(Neighb5, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 3, 3), Neighb5),
    ?equals(nodelist:filter_min_length(Neighb5, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 2, 5), Neighb5),
    ?equals(nodelist:filter_min_length(Neighb5, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 5, 2), Neighb5),

    % Neighb6 = nodelist:mk_neighborhood([], N33, 1, 1),
    % remove non-existing nodes and pids:
    ?equals(nodelist:filter_min_length(Neighb6, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 0, 0), Neighb6),
    ?equals(nodelist:filter_min_length(Neighb6, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 3, 3), Neighb6),
    ?equals(nodelist:filter_min_length(Neighb6, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 2, 5), Neighb6),
    ?equals(nodelist:filter_min_length(Neighb6, fun(N) -> not (node:equals(N, N20) orelse node:equals(N, N66)) end, 5, 2), Neighb6),
...
test_lremove_outdated(_Config) ->
    ...
    ?equals(nodelist:lremove_outdated([N8, N14, N20, N33, N50], N50), [N8, N14, N20, N33]),
    ?equals(nodelist:lremove_outdated([N8, N14, N20, N33, N50, Null], N50), [N8, N14, N20, N33]),
    ?equals(nodelist:lremove_outdated([N8, N14, N20, Null, N33, N50], N50), [N8, N14, N20, N33]),
    ...
    ?equals(nodelist:lremove_outdated([N8, N9, N14, N20, N33, N50], N50), [N9, N14, N20, N33]),
    ?equals(nodelist:lremove_outdated([N8, N9, N14, N20, N21, N33, N50], N50), [N9, N14, N21, N33]),
    ?equals(nodelist:lremove_outdated([N8, N9, N14, N20, N8, N21, N33, N50], N50), [N9, N14, N21, N33]),
    ?equals(nodelist:lremove_outdated([N8, N9, N14, N20, N21, N33, N33, N50, N50], N50), [N9, N14, N21, N33, N33]),
    ...
    ?equals(nodelist:lremove_outdated([N14, N8, N20, N33, N50], N50), [N14, N8, N20, N33]),
    ?equals(nodelist:lremove_outdated([N8, N20, N33, N14, N50, Null], N50), [N8, N20, N33, N14]),
    ?equals(nodelist:lremove_outdated([N8, N20, N33, N14, Null, N50], N50), [N8, N20, N33, N14]),
    ...
    ?equals(nodelist:lremove_outdated([N8, N20, N33, N50, N9, N14], N50), [N20, N33, N9, N14]),
    ?equals(nodelist:lremove_outdated([N9, N14, N20, N8, N21, N33, N50], N50), [N9, N14, N21, N33]),
