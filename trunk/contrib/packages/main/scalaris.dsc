...
Architecture: all
Build-Depends: debhelper (>= 4.1.16), screen, erlang-dev (>= 13.b.1), erlang-tools (>= 13.b.1), erlang-edoc (>= 13.b.1), erlang-crypto (>= 13.b.1), erlang-common-test (>= 13.b.1), pkg-config
Files:
