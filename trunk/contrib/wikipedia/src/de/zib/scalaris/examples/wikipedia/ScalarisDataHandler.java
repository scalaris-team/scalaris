...
public class ScalarisDataHandler {
     ...
     */
    public final static ValueResult<List<String>> getPageList(Connection connection) {
     ...
     * @return a result object with the page list on success
     */
    public final static ValueResult<List<String>> getPageList(int namespace, Connection connection) {
        return getPageList2(connection, ScalarisOpType.PAGE_LIST,
     ...
     * @return a result object with the page list on success
     */
    protected final static ValueResult<List<String>> getPageList2(
     ...
     * @return a result object with the page list on success
     */
    public final static ValueResult<String> getRandomArticle(Connection connection, Random random) {
