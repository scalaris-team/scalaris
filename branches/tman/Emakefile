...
{"src/*", [debug_info, {outdir, "ebin"}, {i, "ebin"}, {i, "include"}, {i, "contrib/yaws/include"}, {i, "contrib/log4erl/include"}]}.
{"src/comm_layer/*", [debug_info, {outdir, "ebin/comm_layer"}, {i, "include"}]}.
{"src/cyclon/*", [debug_info, {outdir, "ebin/cyclon"}, {i, "include"}]}.
{"src/pubsub/*", [debug_info, {outdir, "ebin/pubsub"}, {i, "include"}]}.
